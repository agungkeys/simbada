    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            <header class="main-header"> 
                <a href="page.php?page=dashboard" class="logo" style="
...
"> <!-- Logo -->
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="page.php?page=keluar"><i class="pe-7s-key"></i> Keluar</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <aside class="main-sidebar">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="beranda">
                            <a href="page.php?page=dashboard"><i class="ti-home"></i> <span>Beranda</span>
                        ...
                        <li class="transaksi treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="entryasset"><a href="page.php?page=entryasset">Entry Asset</a></li>
                                <li class="laporanasset"><a href="page.php?page=laporanasset">Laporan Asset</a></li>
                            </ul>
                        </li>
                        <li class="referensi treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="master">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="barang"><a href="page.php?page=masterbarang"> Barang</a></li>
                                        <li class="lokasi"><a href="page.php?page=masterlokasi"> Lokasi</a></li>
                                        <li class="user"><a href="page.php?page=masteruser"> User</a></li>
                                        <li class="agama"><a href="page.php?page=masteragama"> Agama</a></li>
                                    </ul>
                                </li>
                                <li class="kepemilikan"><a href="page.php?page=masterkepemilikan">Kepemilikan</a></li>
                                <li class="currency"><a href="page.php?page=mastercurrency">Mata Uang</a></li>
                                <li class="dataformsurvei">
                                    <a href="index.html#">Data Form Survei
                                        <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li class="kategoriformsurvei"><a href="page.php?page=masterkategoriformsurvei"> Kategori Survei</a></li>
                                        <li class="detailformsurvei"><a href="page.php?page=masterdetailformsurvei"> Detail Survei</a></li>
            ...
            <?php
                ...
                switch ($page) {
                    ...
                    case 'keluar': include "login.php"; break;
        ...
        <script>
            // console.log(page.pageDestination());
