                                ...
                                <li class="laporanasset">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="laporanpenghapusan">
                                            ...
                                            <ul class="treeview-menu">
                                                <li class="asetdihapuskan"><a href="index.php?page=lapasetdihapuskan">Aset Dihapuskan</a></li>
                                                <li class="asetyangtelahdihibahkan"><a href="index.php?page=lapasettelahdihibahkan">Aset Telah Dihibahkan</a></li>
                                                <li class="asetrusakberat"><a href="index.php?page=lapasetrusakberat">Aset Rusak Berat</a></li>
                                                <li class="kemitraandenganpihak3"><a href="index.php?page=lapasetkemitraan">Kemitraan Pihak Ke-3</a></li>
                                                <li class="asettidakberwujud"><a href="index.php?page=lapasettidakberwujud">Aset Tidak Berwujud</a></li>
                                                <li class="asetlainlain"><a href="index.php?page=lapasetlainlainnya">Aset Lain-Lainnya</a></li>
                                                <li class="asetextracountable"><a href="index.php?page=lapasetextracountable">Extra Countable (Kapitalisasi)</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
