<script>
    page.pageDestination("LaporanXXXX")
</script>
<script src="assets/dist/js/laporanxxxx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Kemitraan Pihak Ke 3</h1>
        <small>Laporan Kemitraan Pihak Ke 3</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Kemitraan Pihak Ke 3</li>
        </ol>
    </div>
</section>
<!-- Main content -->
