<script>
    page.pageDestination("LaporanX")
</script>
<script src="assets/dist/js/laporanx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Aset Dihapuskan</h1>
        <small>Laporan Aset Dihapuskan</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Aset Dihapuskan</li>
        </ol>
    </div>
</section>
<!-- Main content -->
