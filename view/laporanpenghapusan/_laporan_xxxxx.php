<script>
    page.pageDestination("LaporanXXXXX")
</script>
<script src="assets/dist/js/laporanxxxxx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Aset Tidak Berwujud</h1>
        <small>Laporan Aset Tidak Berwujud</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Aset Tidak Berwujud</li>
        </ol>
    </div>
</section>
<!-- Main content -->
