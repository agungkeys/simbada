...
$pdf->SetTitle('Laporan Aset Telah Dihibahkan');
$pdf->SetSubject('Laporan Aset Telah Dihibahkan');
$pdf->SetKeywords('Laporan Aset Telah Dihibahkan');
...
$sql = "SELECT KodeLokasi, KodeBarang, NoReg, JenisNamaBarang, NamaBarang, Merk, NomorPabrik, Bahan, AsalUsul, TahunPembelian, Ukuran, Satuan, Kondisi, Jumlah, Nilai, KetStatus FROM view_invallhapus WHERE KodeLokasi IN({$data_arr_location}) {$valasalusul} {$valtahunbetween}  AND Status IN('XX') "; 
...
$pdf->MultiCell(93, 5, '', 0, 'L', 0, 0, '', '', true);
$pdf->MultiCell(92, 5, 'ASET TELAH DIHIBAHKAN', 0, 'C', 0, 0, '', '', true);
$pdf->MultiCell(93, 5, '', 0, 'R', 0, 1, '', '', true);
