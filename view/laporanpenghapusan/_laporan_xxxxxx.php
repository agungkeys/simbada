<script>
    page.pageDestination("LaporanXXXXXX")
</script>
<script src="assets/dist/js/laporanxxxxxx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Aset Lain-Lainnya</h1>
        <small>Laporan Aset Lain-Lainnya</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Aset Lain-Lainnya</li>
        </ol>
    </div>
</section>
<!-- Main content -->
