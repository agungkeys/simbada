<script>
    page.pageDestination("LaporanXXX")
</script>
<script src="assets/dist/js/laporanxxx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Aset Rusak Berat</h1>
        <small>Laporan Aset Rusak Berat</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Aset Rusak Berat</li>
        </ol>
    </div>
</section>
<!-- Main content -->
