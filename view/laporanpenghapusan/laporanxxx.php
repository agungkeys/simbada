...
$pdf->SetTitle('Laporan Aset Rusak Berat');
$pdf->SetSubject('Laporan Aset Rusak Berat');
$pdf->SetKeywords('Laporan Aset Rusak Berat');
...
$sql = "SELECT KodeLokasi, KodeBarang, NoReg, JenisNamaBarang, NamaBarang, Merk, NomorPabrik, Bahan, AsalUsul, TahunPembelian, Ukuran, Satuan, Kondisi, Jumlah, Nilai, KetStatus FROM view_invallhapus WHERE KodeLokasi IN({$data_arr_location}) {$valasalusul} {$valtahunbetween}  AND Status IN('XXX') "; 
...
$pdf->MultiCell(93, 5, '', 0, 'L', 0, 0, '', '', true);
$pdf->MultiCell(92, 5, 'ASET RUSAK BERAT', 0, 'C', 0, 0, '', '', true);
$pdf->MultiCell(93, 5, '', 0, 'R', 0, 1, '', '', true);
