<script>
    page.pageDestination("LaporanXXXXXXX")
</script>
<script src="assets/dist/js/laporanxxxxxxx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Extra Countable (Kapitalisasi)</h1>
        <small>Laporan Extra Countable (Kapitalisasi)</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Extra Countable (Kapitalisasi)</li>
        </ol>
    </div>
</section>
<!-- Main content -->
    ...
    <div class="row">
        <div id="pencarian-laporan" class="col-md-12" style="padding-top: 15px;">
			<div class="panel panel-primary">
				<div class="panel-heading"><h4>Input Filter Pecarian <span id="textinputkib"></span></h4></div>
