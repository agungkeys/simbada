<script>
    page.pageDestination("LaporanXX")
</script>
<script src="assets/dist/js/laporanxx.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Aset Telah Dihibahkan</h1>
        <small>Laporan Aset Telah Dihibahkan</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Aset Telah Dihibahkan</li>
        </ol>
    </div>
</section>
<!-- Main content -->
