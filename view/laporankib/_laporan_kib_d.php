<script>
    page.pageDestination("LaporanKIBD")
</script>
<script src="assets/dist/js/laporankibd.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan KIB D</h1>
        <small>Laporan KIB D. Jalan Irigasi dan Jaringan</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan KIB D</li>
        </ol>
    </div>
</section>
<!-- Main content -->
