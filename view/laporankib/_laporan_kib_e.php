<script>
    page.pageDestination("LaporanKIBE")
</script>
<script src="assets/dist/js/laporankibe.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan KIB E</h1>
        <small>Laporan KIB E. Aset Tetap Lainnya</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan KIB E</li>
        </ol>
    </div>
</section>
<!-- Main content -->
