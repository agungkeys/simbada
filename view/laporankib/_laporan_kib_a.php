<script>
    page.pageDestination("LaporanKIBA")
</script>
<script src="assets/dist/js/laporankiba.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan KIB A</h1>
        <small>Laporan KIB A. Tanah</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan KIB A</li>
        </ol>
    </div>
</section>
<!-- Main content -->
