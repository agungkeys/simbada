<script>
    page.pageDestination("AlatBengkel");
</script>
<script src="assets/dist/js/asetformdatautama.js" type="text/javascript"></script>
<script src="assets/dist/js/asetalatbengkel.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Aset Alat Bengkel</h1>
        <small>Pencarian Aset Alat Bengkel</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Aset Alat Bengkel</li>
        </ol>
    </div>
</section>
<!-- Main content -->
...
<section class="content">
    <div class="row">
        ...
        <div id="table_aset_alatbengkel" class="panel">
            <div id="gridasetalatbengkel" class="panel-body">
                <div class="table-responsive">
                    <table id="DataTableAsetAlatBengkel" class="table table-bordered table-striped table-hover" style="width: auto;">
                        <thead>
                            <tr>
                                <th>Kode&nbsp;Alat</th>
        ...
        <div id="form_aset_alatbengkel" class="col-xs-12 col-sm-6 col-md-6 col-lg-6" hidden>
            <div class="panel panel-bd" >
                <div class="panel-heading">
                    <div class="panel-title">
                        <div class="row">
                            <div class="col-md-10">
                                <h4>Perbaharui Detail Alat Bengkel</h4>
                            </div>
                        </div>
                    </div>
                </div>
