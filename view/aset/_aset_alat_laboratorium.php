<script>
    page.pageDestination("AlatLaboratorium");
</script>
<script src="assets/dist/js/asetformdatautama.js" type="text/javascript"></script>
<script src="assets/dist/js/asetalatlab.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Aset Alat Laboratorium</h1>
        <small>Pencarian Aset Alat Laboratorium</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Aset Alat Laboratorium</li>
        </ol>
    </div>
</section>
<!-- Main content -->
...
<section class="content">
    <div class="row">
        ...
        <div id="table_aset_alatlaboratorium" class="panel">
            <div id="gridasetalatlaboratorium" class="panel-body">
                <div class="table-responsive">
                    <table id="DataTableAsetAlatLaboratorium" class="table table-bordered table-striped table-hover" style="width: auto;">
                        <thead>
                            <tr>
                                <th>Kode&nbsp;Alat</th>
        ...
        <div id="form_aset_alatlaboratorium" class="col-xs-12 col-sm-6 col-md-6 col-lg-6" hidden>
            <div class="panel panel-bd" >
                <div class="panel-heading">
                    <div class="panel-title">
                        <div class="row">
                            <div class="col-md-10">
                                <h4>Perbaharui Detail Alat Laboratorium</h4>
                            </div>
                        </div>
                    </div>
                </div>
