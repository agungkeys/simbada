<script>
    page.pageDestination("Tanaman");
</script>
<script src="assets/dist/js/asetformdatautama.js" type="text/javascript"></script>
<script src="assets/dist/js/asettanaman.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Aset Tanaman</h1>
        <small>Pencarian Aset Tanaman</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Aset Tanaman</li>
        </ol>
    </div>
</section>
<!-- Main content -->
...
<section class="content">
    <div class="row">
        ...
        <div id="table_aset_tanaman" class="panel">
            <div id="gridasettanaman" class="panel-body">
                <div class="table-responsive">
                    <table id="DataTableAsetTanaman" class="table table-bordered table-striped table-hover" style="width: auto;">
                        <thead>
                            <tr>
                                <th>Kode&nbsp;Tanaman</th>
                                ...
                                <th>Nama&nbsp;Pemilik</th>
                                <th style="width: 100px;">Jenis&nbsp;Tanaman</th>
                                <th style="width: 250px;">Nama&nbsp;Tanaman</th>
                                <th>Jenis&nbsp;Kelamin</th>
                                <th>Jumlah</th>
        ...
        <div id="form_aset_tanaman" class="col-xs-12 col-sm-6 col-md-6 col-lg-6" hidden>
            <div class="panel panel-bd" >
                <div class="panel-heading">
                    <div class="panel-title">
                        <div class="row">
                            <div class="col-md-10">
                                <h4>Perbaharui Detail Tanaman</h4>
                            </div>
                        </div>
                    </div>
                </div>
