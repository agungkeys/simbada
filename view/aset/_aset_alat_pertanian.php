<script>
    page.pageDestination("AlatPertanian");
</script>
<script src="assets/dist/js/asetformdatautama.js" type="text/javascript"></script>
<script src="assets/dist/js/asetalatpertanian.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Aset Alat Pertanian</h1>
        <small>Pencarian Aset Alat Pertanian</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Aset Alat Pertanian</li>
        </ol>
    </div>
</section>
<!-- Main content -->
...
<section class="content">
    <div class="row">
        ...
        <div id="table_aset_alatpertanian" class="panel">
            <div id="gridasetalatpertanian" class="panel-body">
                <div class="table-responsive">
                    <table id="DataTableAsetAlatPertanian" class="table table-bordered table-striped table-hover" style="width: auto;">
                        <thead>
                            <tr>
                                <th>Kode&nbsp;Alat</th>
        ...
        <div id="form_aset_alatpertanian" class="col-xs-12 col-sm-6 col-md-6 col-lg-6" hidden>
            <div class="panel panel-bd" >
                <div class="panel-heading">
                    <div class="panel-title">
                        <div class="row">
                            <div class="col-md-10">
                                <h4>Perbaharui Detail Alat Pertanian</h4>
                            </div>
                        </div>
                    </div>
                </div>
