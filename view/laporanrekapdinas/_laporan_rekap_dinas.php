<script>
    page.pageDestination("LaporanRekapDinas")
</script>
<script src="assets/dist/js/laporanrekapdinas.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan Rekap Dinas</h1>
        <small>Laporan Rekap Dinas Aset</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Rekap Dinas</li>
        </ol>
    </div>
</section>
<!-- Main content -->
