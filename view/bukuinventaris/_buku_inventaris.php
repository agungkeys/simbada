<script>
    page.pageDestination("LaporanInventaris")
</script>
<script src="assets/dist/js/laporaninventaris.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        ...
        <small>Laporan Inventaris Aset</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan Inventaris</li>
        </ol>
    </div>
</section>
<!-- Main content -->
