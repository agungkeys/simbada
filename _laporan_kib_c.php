<script>
    page.pageDestination("LaporanKIBC")
</script>
<script src="assets/dist/js/laporankibc.js" type="text/javascript"></script>
...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Laporan KIB C</h1>
        <small>Laporan KIB C. Gedung dan Bangunan</small>
        <ol class="breadcrumb">
            <li><a href="index.php"><i class="pe-7s-home"></i> Beranda</a></li>
            <li class="active">Laporan KIB C</li>
        </ol>
    </div>
</section>
<!-- Main content -->
