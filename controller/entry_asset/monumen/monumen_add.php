<?php
	...
	$sq = "SELECT KodeMonumen FROM datamonumen"; 
	$ress = $mysqli->query($sq);

	$json = [];
	while($row = $ress->fetch_assoc()){
	     $json[] = ['kode'=>substr($row['KodeMonumen'], 2, 8)];
	}
