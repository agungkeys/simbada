<?php
  ...
  $post = $_POST;
  $kodeakeamanan = $post["1"];
  $sql = "UPDATE dataalatkeamanan SET  
      KodeLokasi  = '".$post["3"]."', 
      Keterangan  = '".$post["12"]."' WHERE KodeAlatKeamanan = '".$kodeakeamanan."' ";
  $result = $mysqli->query($sql);
  $sql = "SELECT * FROM dataalatkeamanan WHERE KodeAlatKeamanan = '".$kodeakeamanan."'"; 
  $result = $mysqli->query($sql);
