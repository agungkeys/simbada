<?php
  ...
  $post = $_POST;
  $kodeapertanian = $post["1"];
  $sql = "UPDATE dataalatpertanian SET  
      KodeLokasi  = '".$post["3"]."', 
      Keterangan  = '".$post["12"]."' WHERE KodeAlatPertanian = '".$kodeapertanian."' ";
  $result = $mysqli->query($sql);
  $sql = "SELECT * FROM dataalatpertanian WHERE KodeAlatPertanian = '".$kodeapertanian."'"; 
  $result = $mysqli->query($sql);
