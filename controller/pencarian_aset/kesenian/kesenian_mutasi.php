<?php
  ...
  $post = $_POST;
  $kodebarangkesenian = $post["1"];
  $sql = "UPDATE databarangkesenian SET  
      KodeLokasi  = '".$post["3"]."', 
      Keterangan  = '".$post["12"]."' WHERE KodeBarangKesenian = '".$kodebarangkesenian."' ";
  $result = $mysqli->query($sql);
  $sql = "SELECT * FROM databarangkesenian WHERE KodeBarangKesenian = '".$kodebarangkesenian."'"; 
  $result = $mysqli->query($sql);
