<?php
  ...
  $post = $_POST;
  $kodeakedokteran = $post["1"];
  $sql = "UPDATE dataalatkedokteran SET  
      KodeLokasi  = '".$post["3"]."', 
      Keterangan  = '".$post["12"]."' WHERE KodeAlatKedokteran = '".$kodeakedokteran."' ";
  $result = $mysqli->query($sql);
  $sql = "SELECT * FROM dataalatkedokteran WHERE KodeAlatKedokteran = '".$kodeakedokteran."'"; 
  $result = $mysqli->query($sql);
