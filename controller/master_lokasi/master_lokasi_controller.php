...
$sql = "SELECT KodeLokasi, Unit, SatuanKerja, NamaKu, NipKu, NamaKB, NIPKB, DateCreate";
$sql.=" FROM masterlokasi";
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql = "SELECT KodeLokasi, Unit, SatuanKerja, NamaKu, NipKu, NamaKB, NIPKB, DateCreate";
    $sql.=" FROM masterlokasi";
    $sql.=" WHERE KodeLokasi LIKE '".$requestData['search']['value']."%' ";
    // $requestData['search']['value'] contains search parameter
    $sql.=" OR Unit LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR SatuanKerja LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR NamaKu LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR NipKu LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR NamaKB LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR NIPKB LIKE '".$requestData['search']['value']."%' ";
