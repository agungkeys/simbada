...
$sql = "SELECT 
datatanah.KodeTanah, 
masterlokasi.SubUnit, 
masterlokasi.SatuanKerja, 
masterpemilik.NamaPemilik, 
datatanah.GolonganTanah, 
masterbarang.NamaBarang, 
datatanah.Letak, 
datatanah.LuasTanah, 
datatanah.StatusTanah, 
datatanah.Tanggal, 
datatanah.Nomor, 
datatanah.TahunPerolehan, 
datatanah.Penggunaan, 
datatanah.BatasUtara, 
datatanah.BatasTimur, 
datatanah.BatasSelatan, 
datatanah.BatasBarat, 
datatanah.RangeHarga1, 
datatanah.RangeHarga2, 
datatanah.HargaTanahM2, 
datatanah.HargaTanah, 
datatanah.NilaiPerolehan, 
datatanah.NilaiBaru, 
datatanah.Keterangan, 
datatanah.PenanggungJawab, 
datatanah.EntryUser";
$sql.=" FROM datatanah 
LEFT JOIN masterlokasi ON datatanah.KodeLokasi = masterlokasi.KodeLokasi
LEFT JOIN masterpemilik ON datatanah.KodePemilik = masterpemilik.KodePemilik
LEFT JOIN masterbarang ON datatanah.KodeBarang = masterbarang.KodeBarang";
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql.=" WHERE tanah.KodeTanah LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR lokasi.SubUnit LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR lokasi.SatuanKerja LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR pemilik.NamaPemilik LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.GolonganTanah LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR barang.NamaBarang LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.Letak LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.LuasTanah LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.StatusTanah LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.Tanggal LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.Nomor LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.TahunPerolehan LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.Penggunaan LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.BatasUtara LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.BatasTimur LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.BatasSelatan LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.BatasBarat LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.RangeHarga1 LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.RangeHarga2 LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.HargaTanahM2 LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.HargaTanah LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.NilaiPerolehan LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.NilaiBaru LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.Keterangan LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.PenanggungJawab LIKE '".$requestData['search']['value']."%' ";
    $sql.=" OR tanah.EntryUser LIKE '".$requestData['search']['value']."%' ";
