...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'logo_head.png')) {
		$tcpdf_header_logo = 'logo_head.png';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', '  Kartu Inventaris Barang (KIB)');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "AAAA");
}
